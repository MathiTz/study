...
echo $outraData == $dataFutura ? 'Igual' : 'Diferente'; // igual - por causa do conteúdo
//echo $outraData === $dataFutura ? 'Igual' : 'Diferente'; // diferente - por causa que a comparação leva em consideração o endereço de memória
