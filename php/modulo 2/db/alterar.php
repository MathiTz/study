...
<form action="/exercicio.php" method="get">
  ...
  <div class="form-group row">
    <div class="col-sm-10">
      <input class="form-control" type="text" name="codigo" value="<?= $_GET['codigo']; ?>" placeholder="Informe o código para consulta">
    </div>
  </div>
  <div class="form-group row">
    <div class="col-sm-2">
...
<form action="#" method="post">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control <?= $erros['filhos'] ? 'is-invalid' : ''; ?>" id="filhos" name="filhos"
             placeholder="Filhos"
             value="<?= $dados["filhos"] ?>">
      <div class="invalid-feedback">
        <?= $erros['filhos']; ?>
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control <?= $erros['salario'] ? 'is-invalid' : ''; ?>" id="salario" name="salario"
             placeholder="Salário"
             value="<?= $dados["salario"] ?>">
      <div class="invalid-feedback">
        <?= $erros['salario']; ?>
