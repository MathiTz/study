<aside class="sidebar">
  ...
  <div class="sidebar-widgets">
    <div class="sidebar-widget">
      ...
      <div class="info">
        <span
          class="main text-primary" <?= $activeClock === 'workedInterval' ? 'active-clock' : ''; ?>><?= $workedInterval; ?></span>
    ...
    <div class="sidebar-widget">
      ...
      <div class="info">
        <span
          class="main text-danger" <?= $activeClock === 'exitTime' ? 'active-clock' : ''; ?>><?= $exitTime; ?></span>
